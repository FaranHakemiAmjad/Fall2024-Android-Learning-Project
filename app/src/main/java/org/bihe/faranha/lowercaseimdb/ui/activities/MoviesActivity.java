...
import org.bihe.faranha.lowercaseimdb.databinding.ActivityMoviesBinding;
...
public class MoviesActivity extends AppCompatActivity {
    ...
    public void backFromMovies(View view) {
        finish();
    }
    ...
    public void setUpRecyclerView() {
        ...
        binding.recyclerViewMovies.setAdapter(reportAdapter);
    }

    public void getReports() {
        executorService.execute(new GetAllReportCategoryRunnable(getApplicationContext(), ReportCategory.MOVIES, new DbResponse<List<Report>>() {
            @Override
            ...
            public void onError(Error error) {
                runOnUiThread(() -> Toast.makeText(MoviesActivity.this, error.getMessage(), Toast.LENGTH_SHORT).show());
            }
        }));
    }
}